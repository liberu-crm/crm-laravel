<div class="space-y-6 mt-6 mb-2">
    ...
    <div class="grid gap-4">
        @foreach (\JoelButcher\Socialstream\Socialstream::providers() as $provider)
            <a class="flex gap-2 items-center justify-center transition duration-200 border border-gray-400 dark:border-gray-600 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600"
