...
class CompanyExportTest extends TestCase
{
    ...
    {
        $this->assertNotEmpty(CompanyExporter::getColumns());
    }
    ...
    public function test_free_role_is_denied_the_export(): void
    {
        ...
        // a CSV would otherwise bypass the phone_number/annual_revenue masking.
        ...
        $component = Livewire::test(ListCompanies::class)->assertOk();
