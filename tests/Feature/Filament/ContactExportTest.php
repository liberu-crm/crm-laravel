...
class ContactExportTest extends TestCase
{
    ...
    {
        $this->assertNotEmpty(ContactExporter::getColumns());
    }
    ...
    public function test_free_role_is_denied_the_export(): void
    {
        ...
        // a CSV would otherwise bypass the email/phone_number masking.
        ...
        $component = Livewire::test(ListContacts::class)->assertOk();
