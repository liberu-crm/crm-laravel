# [Liberu CRM](https://www.liberu.co.uk)
...
[![Latest Release](https://img.shields.io/github/v/release/liberu-crm/crm-laravel)](https://github.com/liberu-crm/crm-laravel/releases)
[![Tests Status](https://img.shields.io/github/actions/workflow/status/liberu-crm/crm-laravel/tests.yml?label=tests)](https://github.com/liberu-crm/crm-laravel/actions/workflows/tests.yml)
...
See the [API Documentation](docs/api-documentation.md) for endpoint reference and usage examples.
...
Secure browser-based authorisation is supported for: MailChimp, Stripe Connect, Google/Gmail, Microsoft/Outlook, Facebook, LinkedIn, Twitter, and Zoom. See the [OAuth Authentication Guide](docs/oauth-authentication.md).

### Email Tracking

Open tracking, click tracking, bounce detection, unsubscribe management, engagement scoring, and multi-device tracking. See the [Email Tracking Guide](docs/email-tracking.md).

### Workflow Automation

Build advanced automations with a visual workflow builder. See the [Workflow Automation Guide](docs/workflow-automation.md).
...
We are committed to maintaining an inclusive and respectful environment. All contributors are expected to follow our [Code of Conduct](.github/issue_template.md).
